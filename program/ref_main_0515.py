...
experiment_folder = homefolder+"\program\data\T1897_0_digital"+"\\"
data = []
for i in range(8):
    data.append(pd.read_excel(experiment_folder+"digital_value_1897.xlsx","channel_"+str(i),header=None))
T_ref = np.array(pd.read_excel(experiment_folder+"t_field_1897.xlsx",header=None))
data = np.array(data)
...
save_dir = homefolder+"\\program\\result_v020\\BB_change_e\\T1897_1"
