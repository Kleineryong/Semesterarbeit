...
\begin{figure}[htb]%
    ...
    %
    % Including .png
    \includegraphics[width=40mm]{figures/latex_tutorial/ImagePNG.png}%
    %
    \hspace*{5mm}%
    %
    % Including .pdf
    \includegraphics[width=40mm]{figures/latex_tutorial/ImagePDF.pdf}\par%
    %
    % Including .tikz
    \begingroup%
        %\AMtikzExternalizeSkipNext%
        \resizebox{40mm}{!}{\input{figures/latex_tutorial/ImageTIKZ.tikz}}%
    \endgroup%
    %
    \hspace*{5mm}%
    %
    ...
    \begingroup%
        ...
        \input{figures/latex_tutorial/ImagePDFTEX.pdf_tex}%
    \endgroup%
    %
...
\begin{figure}[htb]%
    \centering%
    \input{figures/latex_tutorial/plot_two_dim.tikz}%
...
\begin{figure}[htb]%
    \centering%
    \input{figures/latex_tutorial/plot_three_dim.tikz}%
