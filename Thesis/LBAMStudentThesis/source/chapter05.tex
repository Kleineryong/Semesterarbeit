...
In the computation results of the linear model, it can be observed 
that the temperature estimation algorithm based on this model 
introduces significant errors, particularly when calculating 
temperatures for blackbody materials, with relative errors exceeding 10\%. 
Additionally, in the temperature estimation for other hypothetical 
materials, the linear model performs poorly in the liquid state 
region. This limitation may arise from the inability of the linear 
model to accurately reproduce the complexities of real emissivity models.
...
In this linear square model, the introduction of an additional 
parameter results in an emissivity model with one more degree of 
freedom compared to the linear model. Consequently, this model is better 
suited for accurately characterizing the emissivity properties of real 
materials. Simultaneously, it can also provide accurate estimations for 
materials with relatively simpler emissivity models.
\begin{figure}[htbp]
    \centering
    \begin{minipage}{\textwidth}
        \centering
