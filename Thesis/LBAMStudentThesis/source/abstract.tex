...
\IWBstudentthesisAbstract{%
	...
	multispectral image without interference and determine the accuracy of temperature
	estimation algorithm using real temperature of the measured object.
	...
	In the conducted tests within this work, the temperature estimation algorithm 
	has demonstrated 
