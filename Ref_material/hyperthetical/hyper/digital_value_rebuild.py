    ...
    for channel in cam_efficiency.keys():
        ...
        def radiation_integration(temperature, emissivity_data, cam_efficiency_data):
            ...
            with warnings.catch_warnings():
                ...
                radiation_rec = quad(radiation, 500 * (10**-9), 900 * (10**-9), limit=5)[0] * 200      # 200 means the calibration factor and shutter time
...
def emissivity(temperature, wavelength, emi_function):
    emi =2 * ( -emi_function(wavelength*(10**9)) * 0.02 * (temperature - 1500) / 500 + emi_function(wavelength * (10**9)))
    if temperature>1500:
        emi = emi*0.1
    return emi
